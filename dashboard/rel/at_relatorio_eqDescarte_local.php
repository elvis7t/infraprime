...
?>
								...
								<div class="box-body">
									...
									<div class="row">
										...
										<div class="form-group col-xs-2">
											...
											<input type="text" class="form-control" name="rel_df" id="rel_df" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask/>
											...
											<table class="table table-striped">
												<thead>
													<tr>
														<th colspan=7>
															<h2>
																Relat&oacute;rio de Equipamentos Descartados
															</h2>
														</th>
													</tr>
    ...
    <script src="<?=$hosted;?>/dashboard/js/action_ativoslocais.js"></script>
