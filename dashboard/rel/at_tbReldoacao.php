	...
	<tr>
		...
		<td>
			<div class="button-group">
				<a 	class="btn btn-md btn-primary" data-toggle='tooltip' data-placement='bottom' title='Gerar Rel&aacute;torio' a href="cabecario_rel_doacao.php?token=<?=$_SESSION['token']?>&acao=N&instid=<?=$rs->fld("inst_id");?>"><i class="fa fa-file-text-o"></i></a>
			</div>
		</td>   
