						...
						<form role="form" id="rels">
							...
							<div class="box-body">
								...
								<div class="row">
									<div class="col-xs-12 table-responsive">
										<table class="table table-striped">
											<thead>
												<tr><th colspan=7><h2>Relat&oacute;rio de Servidores Ativos Totais</h2></th></tr>
												<tr> 										
													<th>Empresa</th> 										
													<th>Nome</th>
													<th>Fabricante</th>													
								...
								<div class="row no-print">
									<div class="col-xs-12">								
										<button class="btn btn-sm btn-primary" type="button" id="bt_relSR_total"><i class="fa fa-file-pdf-o"></i> Gerar Relat&oacute;rio</button>
