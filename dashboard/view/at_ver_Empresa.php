...
?>
			 ...
			 <div class="row"> 
				...
				<div class="box box-primary">
					<div class="box-header with-border">
						<img class="img-fluid img-thumbnail img-responsive " src="<?=$hosted;?>/dashboard/<?=$rs->fld('emp_logo');?>" alt="Logo da Empresa"> 
							<h2><?=$rs->fld("emp_nome");?>								
 ...
 <?php
				...
				$sql ="SELECT * FROM at_maquinas
				WHERE YEAR(mq_datagar) < YEAR(CURDATE( ))AND mq_ativo = '1' AND mq_empId=".$empid;    
				$rs->FreeSql($sql);
				while($rs->GeraDados()){ }
				$mq_semgar  = $rs->linhas;
