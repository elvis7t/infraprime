	...
	<tr>
		...
		<td>
			<div class="button-group">
				<a 	class="btn btn-xs btn-primary" data-toggle='tooltip' data-placement='bottom' title='Alterar ' a href="at_alt_Inst.php?token=<?=$_SESSION['token']?>&acao=N&instid=<?=$rs->fld('inst_id');?>"><i class="fa fa-pencil"></i></a>
				<a 	class="btn btn-xs btn-warning"
						data-toggle='tooltip' 
						data-placement='bottom'     
						title='Detalhes'
						a href="at_ver_Instituicao.php?token=<?=$_SESSION['token']?>&acao=N&instid=<?=$rs->fld('inst_id');?>"><i class="fa fa-search"></i> 
					</a>
