...
$sql ="	SELECT * FROM at_maquinas a
		...
		WHERE mq_ativo = '0' AND  mq_tipoId  IN  ('10','51','84','85','86','87')"; 
		$rs->FreeSql($sql);
	...
	<tr>
		...
		<td>   
			<div class="button-group">	
				<a 	class="btn btn-xs btn-success" data-toggle='tooltip' data-placement='bottom' title='Visualizar'  a href="at_ver_Servidor.php?token=<?=$_SESSION['token']?>&acao=N&mqid=<?=$rs->fld('mq_id');?>"><i class="fa fa-search"></i></a>																														
			</div>  
		</td>		
	</tr>	
<?php }
