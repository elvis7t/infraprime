				...
				<div class="col-md-12">
					...
					<div class="box box-primary">
						<div class="box-header with-border">
							<div class="col-md-2"><img class="profile-user-img img-responsive img-circle" src="<?=$hosted."/dashboard/".$rs->fld('emp_logo');?>" alt="Logo da Empresa"></div> 
								<h1><?=$rs->fld("emp_nome");?>								
						...
						<form role="form" id="alt_emp">  							
							...
							<div class="box-footer">
								...
								<a 	class="btn btn-sm btn-info" data-toggle='tooltip' data-placement='bottom' title='Atribuir imagem'  a href="at_img_crfrent_empresa.php?token=<?=$_SESSION['token']?>&acao=N&empid=<?=$empid;?>"><i class="fa fa-file-image-o"></i> Layout cracha frente</a>
								<a 	class="btn btn-sm btn-info" data-toggle='tooltip' data-placement='bottom' title='Atribuir imagem'  a href="at_img_crverso_empresa.php?token=<?=$_SESSION['token']?>&acao=N&empid=<?=$empid;?>"><i class="fa fa-file-image-o"></i> Layout cracha verso</a>
