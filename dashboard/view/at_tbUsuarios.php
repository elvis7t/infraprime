...
while($rs->GeraDados()){ ?>
	...
	<td> 
			<div class="button-group">
				<a 	class="btn btn-xs btn-primary" data-toggle='tooltip' data-placement='bottom' title='Alterar Usuário' a href="at_alt_Usu.php?token=<?=$_SESSION['token']?>&acao=N&usuid=<?=$rs->fld('usu_id');?>"><i class="fa fa-pencil"></i></a>
				...
				<a 	class="btn btn-xs btn-warning" data-toggle='tooltip' data-placement='bottom' title='Detalhes' a href="at_ver_Usuario.php?token=<?=$_SESSION['token']?>&acao=N&usuid=<?=$rs->fld('usu_id');?>"><i class="fa fa-search"></i></a>  
			</div>
		</td> 
