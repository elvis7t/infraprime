        ...
        <section class="content">
			<?php
				$menu = array(
							...
							"N" => array("class" => "btn btn-warning btn-sm", "icone" => "fa fa-refresh", "id"=>"btn_AltMem","label"=>"Alterar") 
							);
 				extract($_GET);
 				$rs = new recordset();
							...
							<div class="box-body">
								...
								<div id="usuarios" class="row">    
									<div class="form-group col-xs-1">
										...
										<input type="text" DISABLED class="form-control" name="mem_id" id="mem_id" value="<?=$rs->fld("mem_id");?>"/>
									...
									<div class="form-group col-xs-3 ">
										...
										<input type="text"  class="form-control" name="mem_tipo" id="mem_tipo" value="<?=$rs->fld("mem_tipo");?>"/>
										<input type="hidden" value="<?=$_SESSION['token'];?>" name="token" id="token">
										<input type="hidden" value="<?=isset($_GET['lista']) ? $_GET['lista']: 0 ;?>" name="lista" id="lista">
									</div>
									</div>
									 <div class="form-group col-xs-3 ">  
										<label for="fab_nome">Capacidade</label>
										<div class="input-group">
										<div class="input-group-addon">
											<i class="fa fa-industry"></i>
										</div>
										<input type="text"  class="form-control" name="mem_cap" id="mem_cap" value="<?=$rs->fld("mem_cap");?>"/>
									</div> 
									</div> 
