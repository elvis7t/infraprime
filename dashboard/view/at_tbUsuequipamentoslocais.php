...
$sql ="SELECT * FROM at_equipamentos a
		...
		WHERE eq_ativo <> 1 and eq_usuId =".$usuid;   
		$rs->FreeSql($sql);
	...
	<td>   
			<div class="button-group">  
				...
				<?php 
					...
					<a 	class="btn btn-xs btn-primary" data-toggle='tooltip' data-placement='bottom' title='Gerar Termo'  a href="at_vis_termo_Eqlocal.php?token=<?=$_SESSION['token']?>&acao=N&eqid=<?=$rs->fld("eq_id");?>"><i class="fa fa fa-file-text"></i></a>
					<?php else: ?>
...
//echo "<tr><td colspan=7><strong>".$rs->linhas." Equipamnetos</strong></td></tr>";    
endif;
?>   