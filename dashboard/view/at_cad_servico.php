							...
							<div class="box-body">							
								<div class="row">
									<div class="form-group  col-md-3"> 
									  <label for="servico_servidorId">Selecione o Servidor</label>
										<div class="input-group">
											<div class="input-group-addon">
												<i class="fa fa-server"></i>
											</div>
											<select class="select2 form-control" class="form-control" id="servico_servidorId" name="servico_servidorId">
												<option value="">Selecione...</option> 
												<?php
												$rs->Seleciona("*","at_maquinas", "mq_ativo = '1' AND  mq_tipoId  IN  ('10','51','84','85','86','87')");
												while($rs->GeraDados()){ ?>
					...
					<div class="box-body">
						<table id="servico" class="table table-bordered table-striped">
							...
							<tbody id="cad_Servico">
								<?php require_once("at_tbServico.php");?> 
							</tbody>  
