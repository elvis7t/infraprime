...
session_start();
$sess = "PESSOAL";
$pag = "at_usuarios_pessoal.php";// Fazer o link brilhar quando a pag estiver ativa
					...
					<div class="box box-primary">
						...
						<form role="form" id="alt_emp">								
									...
									<div class="form-group col-md-4">
									  <label for="emp_id">#Empresa:</label>
										<div class="input-group">
											...
											<input type="hidden" value="<?=$_SESSION['token'];?>" name="token" id="token">
											<input type="hidden" value="<?=isset($_GET['lista']) ? $_GET['lista']: 0 ;?>" name="lista" id="lista">
											<input type="hidden" value="<?=$emp_id;?>" name="sel_emp" id="sel_emp">
										</div>
									</div>
									...
									<div class="form-group col-md-4">  
									  <label for="usu_chapa">Cargo</label>
										<div class="input-group">
											...
											<input type="text"  class="form-control" name="usu_cargo" id="usu_cargo" maxlength="16" value="<?=$usu_cargo?>"/> 
										</div>
									</div>
								</div> 
							...
							<div class="box-footer">
								...
								<a 	class="btn btn-sm btn-info" data-toggle='tooltip' data-placement='bottom' title='Atribuir imagem'  a href="at_img_usu_crachadp.php?token=<?=$_SESSION['token']?>&acao=N&usucod=<?=$usuid;?>"><i class="fa fa-file-image-o"></i> Foto</a>
