		...
		<tr>
			...
			<td>
				<div class="button-group">
					<a 	class="btn btn-xs btn-primary" data-toggle='tooltip' data-placement='bottom' title='Alterar' a href="at_alt_Memoria.php?token=<?=$_SESSION['token']?>&acao=N&memid=<?=$rs->fld('mem_id');?>"><i class="fa fa-pencil"></i></a>
