			...
			<div class="row">
				...
				<div class="box box-success"> 
					...
					<div class="box-footer">
						<a class='btn btn-sm btn-success' data-toggle='tooltip' data-placement='bottom' title='Nova DP' href="at_vis_Departamentos_pessoal.php?token=<?=$_SESSION['token']?>"><i class="fa fa-plus"></i> Novo</a>
					</div>							
				</div><!-- /.box --> 
			</div>
        </section><!-- /.content --> 
