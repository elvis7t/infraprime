						...
						<div class="box-footer">
							...
							<table id="maquinas" class="table table-bordered table-striped">     
								<tr> 
									...
									<td>
										<a 	class="btn btn-sm btn-success" data-toggle='tooltip' data-placement='bottom' title='Alterar usu&aacute;rio'  a href="at_alt_usu_Mq.php?token=<?=$_SESSION['token']?>&acao=N&mqid=<?=$mq_id?>"><i class="fa fa-user-plus"></i> Alterar usu&aacute;rio</a>
									</td>
									<td>
									...
									<td>
										<a 	class="btn btn-sm btn-danger" data-toggle='tooltip' data-placement='bottom' title='Descarte'  a href="at_descartar_Mq.php?token=<?=$_SESSION['token']?>&acao=N&mqid=<?=$mq_id?>"><i class="fa fa-recycle"></i> Descartar</a>
									</td>
									<td>
									...
									<td>
										<a 	class="btn btn-sm btn-primary" data-toggle='tooltip' data-placement='bottom' title='Atribuir Nota'  a href="at_upload_nota_fiscal.php?token=<?=$_SESSION['token']?>&acao=N&mqid=<?=$mq_id;?>"><i class="fa fa-file-pdf-o"></i> Nota</a>
									</td> 								
								</tr>
							</table>							
						</div>
