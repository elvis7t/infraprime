	...
	<td>   
			<div class="button-group">  
				<?php 
					...
					<a 	class="btn btn-xs btn-primary" data-toggle='tooltip' data-placement='bottom' title='Gerar Termo'  a href="at_vis_termo_Eq.php?token=<?=$_SESSION['token']?>&acao=N&eqid=<?=$rs->fld("eq_id");?>"><i class="fa fa fa-file-text"></i></a> 
					<?php else: ?>
