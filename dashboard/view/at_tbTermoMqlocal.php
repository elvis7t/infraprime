	...
	<tr>
		...
		<td>
			<div class="button-group">
				<a 	class="btn btn-ms btn-primary" data-toggle='tooltip' data-placement='bottom' title='Gerar termo' a href="at_termo_Mqlocal.php?token=<?=$_SESSION['token']?>&acao=N&trmid=<?=$rs->fld('trm_id');?>"><i class="fa fa fa-file-text"></i></a>
			</div>
		</td> 
	</tr>	
<?php  
